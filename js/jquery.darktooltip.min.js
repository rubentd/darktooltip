...
this.modalLayer=$("<ins class='darktooltip-modal-layer'></ins>");this.tooltip=$("<ins "+tooltipId+" class = 'dark-tooltip "+this.options.theme+" "+this.options.size+" "
+this.options.gravity+"'><div>"+this.content+"</div><div class = 'tip'></div></ins>");this.tip=this.tooltip.find(".tip");$("body").append(this.modalLayer);$("body").append(this.tooltip);if(this.contentType=='html'){this.tooltip.css('max-width','none');}
...
dt.toggle();e.stopPropagation();});$('html').click(function(){dt.hide();})}},activate:function(){this.setContent();if(this.content){this.setEvents();}},addConfirm:function(){this.tooltip.append("<ul class = 'confirm'><li class = 'darktooltip-yes'>"
